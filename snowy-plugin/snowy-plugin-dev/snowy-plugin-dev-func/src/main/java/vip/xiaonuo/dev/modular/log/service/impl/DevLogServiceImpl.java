...
public class DevLogServiceImpl extends ServiceImpl<DevLogMapper, DevLog> implements DevLogService {
    ...
    public List<DevLogVisPieChartDataResult> visLogPieChartData() {
        ...
        devLogLoginPieChartDataResult.setValue(Long.valueOf(this.count(new LambdaQueryWrapper<DevLog>()
        ...
        devLogLogoutPieChartDataResult.setValue(Long.valueOf(this.count(new LambdaQueryWrapper<DevLog>()
    ...
    public List<DevLogOpPieChartDataResult> opLogPieChartData() {
        ...
        devLogOperatePieChartDataResult.setValue(Long.valueOf(this.count(new LambdaQueryWrapper<DevLog>()
        ...
        devLogExceptionPieChartDataResult.setValue(Long.valueOf(this.count(new LambdaQueryWrapper<DevLog>()

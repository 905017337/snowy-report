...
import vip.xiaonuo.report.modular.dashboard.controller.dto.ReportDashboardDto;
import vip.xiaonuo.report.modular.dashboard.controller.dto.ReportDashboardObjectDto;
import vip.xiaonuo.report.modular.dashboard.mapper.ReportDashboardMapper;
...
import vip.xiaonuo.report.modular.dashboardwidget.controller.dto.ReportDashboardWidgetDto;
import vip.xiaonuo.report.modular.dashboardwidget.controller.dto.ReportDashboardWidgetValueDto;
...
import vip.xiaonuo.report.modular.file.util.FileUtils;
import vip.xiaonuo.report.modular.report.service.ReportService;
import vip.xiaonuo.report.util.DateUtil;
import vip.xiaonuo.report.util.FileUtil;
import vip.xiaonuo.report.util.RequestUtil;
        ...
        for (int i = 0; i < files.length; i++) {
            ...
            if (JSON_PATH.equals(childFile.getName())) {
                ...
                for (File imageFile : imageFiles) {
                    ...
                    GaeaFile gaeaFile = gaeaFileService.getOne(queryWrapper);
                    String uploadPath;
                    if (null == gaeaFile) {

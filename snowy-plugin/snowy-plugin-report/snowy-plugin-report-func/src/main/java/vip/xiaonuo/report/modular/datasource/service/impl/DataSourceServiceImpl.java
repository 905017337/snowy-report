...
package vip.xiaonuo.report.modular.datasource.service.impl;
...
import vip.xiaonuo.report.core.constant.BusinessConstant;
...
import vip.xiaonuo.report.modular.datasource.mapper.DataSourceMapper;
...
import vip.xiaonuo.report.modular.datasource.service.JdbcService;
...
public class DataSourceServiceImpl extends ServiceImpl<DataSourceMapper, DataSource> implements DataSourceService {
    ...
    @Override
    public IPage<DataSource> pageList(DataSourceParam param) {
        QueryWrapper<DataSource> queryWrapper = new QueryWrapper<>();
        if(ObjectUtil.isNotEmpty(param.getOrder())) {
            if("ASC".equals(param.getOrder())){
                queryWrapper.lambda().orderByAsc(DataSource::getUpdateTime);
            }
            if("DESC".equals(param.getOrder())){
                queryWrapper.lambda().orderByDesc(DataSource::getUpdateTime);
            }
        }
